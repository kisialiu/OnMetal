...
class SearchAlbumsActivity : BaseActivity() {
    ...
    private lateinit var adapter: SearchDiscsAdapter
    ...
    private fun loadNextPage(res: DiscsSearchResults) {
        disposable = Single
                .fromCallable(Callable<DiscsSearchResults> {
                    val url = buildGetDiscs(res.searchField, currentPage.toString())
