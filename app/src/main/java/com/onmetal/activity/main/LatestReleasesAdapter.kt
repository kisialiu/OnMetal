...
class LatestReleasesAdapter(val discs: List<Disc>, val item: Int) : RecyclerView.Adapter<LatestReleasesAdapter.ResultsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): ResultsViewHolder {
        ...
        return ResultsViewHolder(v, logosCache)
    }
    ...
    override fun onViewDetachedFromWindow(holder: LatestReleasesAdapter.ResultsViewHolder?) {
